...
class StartupApplicationInline(admin.TabularInline):
    """Inline display of applications within the Startup admin panel."""
...
class StartupAdmin(admin.ModelAdmin):
    ...
    inlines = [StartupApplicationInline]  # Display related applications inline

@admin.register(StartupApplication)
class StartupApplicationAdmin(admin.ModelAdmin):
    """Admin configuration for StartupApplication model."""
